package ru.zar1official.hackathon_final.domain.repositories
...
interface Repository {
    ...
    suspend fun readLongFromPrefs(key: String): Long?
    suspend fun saveLongInPrefs(key: String, long: Long)
}